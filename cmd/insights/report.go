...
// NewReportCmd creates the 'insights report' command.
...
which topics should become coding rules.`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			r, err := insights.BuildReport(dataset, insights.ReportOptions{
				Topics: topics,
			...
			switch {
			case exporter != nil:
				return insights.WriteReportJSON(w, r)
			default:
				return insights.WriteReportMarkdown(w, r)
			}
		},
	}
