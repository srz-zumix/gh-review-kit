...
gh review-kit insights estimate --repo ghes.example.com/owner/repo
gh review-kit insights extract --repo ghes.example.com/owner/repo --dataset ./dataset
...
```bash
gh review-kit insights estimate --repo owner/repo
...
gh review-kit insights estimate --repo owner/repo --merged --since 2024-01-01T00:00:00Z
...
gh review-kit insights extract --repo owner/repo --dataset ./review-corpus --update
gh review-kit insights validate --dataset ./review-corpus --strict
gh review-kit insights report   --dataset ./review-corpus --output ./review-report.md
```
...
```bash
gh review-kit insights stats   --dataset ./review-corpus --group-by path_prefix --top 30
...
Use after `gh review-kit insights sample --strategy blocking --output ./evidence.jsonl`.
...
Use after `gh review-kit insights suggest-rules --format json --output ./candidates.json`.
...
Use after `gh review-kit insights bundle --group-by repo --max-bytes 500000 --output-dir ./bundles`.
...
Use after `gh review-kit insights report --output ./review-report.md`.
